...
export default function FeedbackAnalysis() {
  ...
  const loadAnalyses = async () => {
    try {
      // FeedbackAnalysis table doesn't exist - use Reviews instead
      const reviews = await base44.entities.Review.list("-created_date", 10);
      // Transform reviews into analysis format
      setAnalyses(reviews.map(r => ({
        id: r.id,
