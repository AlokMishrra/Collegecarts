...
import { Sparkles, Send, Play, Plus, TrendingUp, Mail, Bell, Loader2 } from "lucide-react";
...
export default function MarketingAutomation() {
  ...
  const loadCampaigns = async () => {
    try {
      // Use existing Campaign entity instead of MarketingCampaign
      ...
      for (const user of targetUsers) {
        ...
        if (campaign.type === 'email' || campaign.type === 'both') {
          try {
            ...
            // Continue with campaign even if email fails
          }
        }
