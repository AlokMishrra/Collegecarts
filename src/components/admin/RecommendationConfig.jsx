...
export default function RecommendationConfig() {
  ...
  const loadSettings = async () => {
    try {
      // Settings table doesn't have 'key' column - just use default settings
      setSettings({
        strategy: 'ai_powered',
        max_recommendations: 8,
        use_purchase_history: true,
  ...
  const handleSave = async () => {
    setIsSaving(true);
    try {
      // Save to localStorage for now since settings table structure is different
      localStorage.setItem('recommendation_settings', JSON.stringify(settings));
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <Select value={settings.strategy || 'ai_powered'} onValueChange={(value) => setSettings({...settings, strategy: value})}>
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
            ...
            <div>
              ...
              <Select 
                value={(settings.max_recommendations || 8).toString()} 
            ...
            {settings.strategy === "ai_powered" && (
              <div>
                <Label>AI Creativity Level: {settings.ai_model_temperature || 0.7}</Label>
                <Slider
                  value={[settings.ai_model_temperature || 0.7]}
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
              ...
              <Switch
                id="purchase_history"
                checked={settings.use_purchase_history || false}
            ...
            <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
              ...
              <Switch
                ...
                checked={settings.use_browsing_behavior || false}
            ...
            <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
              ...
              <Switch
                id="loyalty_tier"
                checked={settings.use_loyalty_tier || false}
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
              ...
              <Switch
                id="high_margin"
                checked={settings.boost_high_margin || false}
            ...
            <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
              ...
              <Switch
                id="new_products"
                checked={settings.boost_new_products || false}
        ...
        <Card className="bg-gradient-to-br from-purple-50 to-indigo-50 border-purple-200">
          ...
          <CardContent className="space-y-2">
            <div className="flex items-center gap-2">
              <Badge className="bg-purple-600">Strategy: {settings.strategy || 'ai_powered'}</Badge>
            </div>
            <div className="text-sm text-gray-700 space-y-1">
              <p>✓ Showing {settings.max_recommendations || 8} recommendations</p>
