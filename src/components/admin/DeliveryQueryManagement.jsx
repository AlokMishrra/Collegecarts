              ...
              <CardContent className="p-4">
                <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-3">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-800">{q.message || q.description}</p>
                    {q.admin_reply && (
                      <div className="mt-2 bg-blue-50 rounded-lg p-2 border-l-2 border-blue-400">
                        ...
                        <p className="text-xs text-blue-800 mt-0.5">{q.admin_reply}</p>
                      </div>
                    )}
          ...
          {respondDialog.query && (
            <div className="space-y-4">
              <div className="bg-gray-50 rounded-lg p-3 text-sm">
                ...
                <p className="text-gray-800">{respondDialog.query.message || respondDialog.query.description}</p>
              </div>
              <div>
