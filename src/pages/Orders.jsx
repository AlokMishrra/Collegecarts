...
import { Package, Clock, Truck, CheckCircle, XCircle, Edit, Plus, Search, History, Filter } from "lucide-react";
...
export default function Orders() {
  ...
  const activeOrders = filterOrders(orders.filter(order => 
    ['pending', 'confirmed', 'scheduled', 'preparing', 'out_for_delivery'].includes(order.status)
  ));
        ...
        <Card className="hover:shadow-lg transition-shadow">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="border-t pt-4">
                    ...
                    {order.delivery_otp && ['confirmed', 'scheduled', 'preparing', 'out_for_delivery'].includes(order.status) && (
