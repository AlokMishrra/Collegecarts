...
export default function Profile() {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6 pb-tab-bar">
      {/* Profile Header */}
            ...
            <CardContent className="space-y-4">
              <div className="bg-white rounded-lg p-4 border border-red-200">
                ...
                <ul className="text-sm text-gray-600 space-y-1 mb-4 ml-4">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-red-600">•</span>
                    <span>Order history and tracking data</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-red-600">•</span>
                    <span>Loyalty points balance ({loyaltyBalance} points)</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-red-600">•</span>
                    <span>Wishlist and saved addresses</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-red-600">•</span>
