-- Stock functions written WITHOUT dollar-quoting.
-- Uses LANGUAGE SQL where possible, and single-quoted bodies for plpgsql.

ALTER TABLE public.products
  ADD COLUMN IF NOT EXISTS reserved_stock integer DEFAULT 0;

-- reserve_stock using LANGUAGE SQL (no dollar-quoting needed)
